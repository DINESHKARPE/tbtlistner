...
util.inherits(tbtListener, EventEmitter);

function tbtListener(opts, callback) {

    if (!(this instanceof tbtListener)) {
        return new tbtListener(opts, callback);
    }
    ...
    this.init = function (cb) {
        ...
        if (typeof _this.opts.device_adapter === 'string') {
            console.log(_this.opts.device_adapter);
            ...
            //Get the adapter
            const adapterFile = (this.availableAdapters[this.opts.device_adapter]);
    ...
    this.send_to = function (deviceId, msg) {
        this.find_device(deviceId).send(msg);
    };

    return this;
}

exports.tbtListener = tbtListener;
